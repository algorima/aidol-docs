...
| **판단 기준** | **TBD** - 현재 Sprint 1 캐릭터 생성에 나이/생년월일 필드가 없음. 미성년자 판단 기준 정의 필요:<br>- 옵션 1: 캐릭터 생성 시 나이 또는 생년월일 필드 추가<br>- 옵션 2: 이미지 분석을 통한 자동 판단 (Vertex AI Safety Filter)<br>- 옵션 3: 모든 캐릭터를 성인으로 간주 (서비스 정책으로 명시) |
