...
| 검은 박스티, 클로즈업, 약간의 미소 | 후드 착용, 폰으로 얼굴 일부 가리기 | 아래를 내려다보는 무드샷 | 연습실 바닥에 앉아서, 흰 박스티 |
...
| 플래시 반사, 시선 분산 | 한 손 볼에 대기, 윙크 | 폰 화면 보여주기, 입술 포즈 | 폰 화면 보여주기, 무표정 |
